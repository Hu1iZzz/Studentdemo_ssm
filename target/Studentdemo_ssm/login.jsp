...
<FORM id=adminlogin  method=post
	name=adminlogin action="${pageContext.request.contextPath}/cuser/login"  >
<DIV></DIV>
	...
	<TBODY>
		...
		<TR style="HEIGHT: 254px">
			...
			<TABLE border=0 cellSpacing=0 cellPadding=0 width="100%">
				<TBODY>
					<TR>
						<TD style="HEIGHT: 45px"><INPUT type="text" class=input value="${cuser.userid }" name="userid" id="userid"></TD>
					</TR>
					<TR>
						<TD><INPUT type="password" class=input value="${cuser.password }" name="password" id="password"/></TD>
					</TR>
					<TR>
						<td>
							<select id="type" name="type" class="input"  style="margin-top: 15px;height: 24px" >
